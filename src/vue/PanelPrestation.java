...
public class PanelPrestation extends PanelDeBase implements ActionListener
{
	...
	public PanelPrestation()
	{
		...
		String entetes[]= {" Code "," Libelle ",
				" Places ","  Date  ","  Heure  "," Type ","Famille"};
	...
	public Object[][] getLesDonnees(String mot) // 24/01
	{
		...
		Object[][] matrice = new Object[lesPrestations.size()][7]; //lesPilotes.size pour le nombre de lignes et 6 pour le nb 
		int i = 0;												// de colonnes
	...
	public Prestation saisirPrestation() //séance 28/01
	{
		...
		if( ! libellepresta.equals("") && ! nombreplaces.equals("") && ! datepresta.equals("") 
				&& ! heurepresta.equals("") )
		{
			 unePrestation= new Prestation(libellepresta,nombreplaces,datepresta,heurepresta,codetypepresta,idfamille);
		}
		else 
		{
			return null;
	...
	public void actionPerformed(ActionEvent e) 
	{
		...
		}else if(e.getSource() == this.btEnregistrer  && e.getActionCommand().equals("Enregistrer"))		
		{
				...
				Prestation unePrestation = this.saisirPrestation();
				if(unePrestation != null)
				{
					
				Modele.insertPrestation(unePrestation);
