...
drop database if exists Villierbddlourd;
create database Villierbddlourd;
use Villierbddlourd;
...
/*------------------INSERTION---------------------*/
	...
	insert into userppe values(null,'aghouiles','darren','d@hotmail.fr','123','admin');
	...
	insert into prestation values(null,'Garderie enfant','10','2022-01-12','12:00:00','1','2');

	insert into prestation values(null,'Recolte nourriture','50','2021-12-02','13:00:00','2','3');

	insert into prestation values(null,'Acommpagner enfant','50','2022-03-12','15:00:00','3','1');
...
/* DROP TRIGGER IF EXISTS email_verification; 
DELIMITER //
